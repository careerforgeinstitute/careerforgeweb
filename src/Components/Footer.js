      ...
      <div className="footer-cta-box">
        ...
        <div>
          ...
          <p className="footer-cta-description">
            Learn Business Analysis, Agile, Jira and AI-powered
            workflows through practical industry-oriented training.
          </p>
    ...
    <div className="row gy-5">
      ...
      <div className="col-lg-4">
        ...
        <div className="footer-brand">
          ...
          <p>
            Helping students and professionals become
            industry-ready Business Analysts through
            practical training, Agile workflows and
            AI-powered learning.
          </p>
      ...
      <div className="col-lg-2 col-md-6">
        ...
        <div className="footer-links-modern">
          ...
          <ul>
            ...
            <li><Link to="/payment">Enrollment</Link></li>
      ...
      <div className="col-lg-3">
        ...
        <div className="footer-contact-modern">
          ...
          <p>
            careerforgeinstitute@gmail.com
          </p>
