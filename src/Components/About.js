        ...
        <div className="container position-relative z-3">
          <div className="row justify-content-center text-center">
            <div className="col-lg-9">
              <span className="about-badge">ABOUT CAREERFORGE</span>
              ...
              <p className="about-hero-description mt-4">
                CareerForge Institute helps students and professionals build
                practical Business Analysis, Agile and AI-powered skills through
                real-world project scenarios, mentorship and hands-on learning.
              </p>
          ...
          <div className="row align-items-center gy-5">
            ...
            <div className="col-lg-6" data-aos="fade-right">
              <div className="modern-about-image-wrapper">
                ...
                <div className="floating-about-card">
                  ...
                  <span>Learn Real Industry Workflows</span>
                </div>
              </div>
            </div>
            ...
            <div className="col-lg-6" data-aos="fade-left">
              ...
              <p className="modern-about-description mt-4">
                ...
                industry-oriented Business Analysis training rather than just
                theoretical concepts. We help learners understand how Business
                Analysts actually work inside Agile IT teams using Jira,
                stakeholder collaboration, AI tools and real project scenarios.
              </p>
          ...
          <div className="row gy-4">
            ...
            <div className="col-lg-6" data-aos="zoom-in">
              <div className="mission-card">
                ...
                <p>
                  To help aspiring professionals become confident, job-ready
            ...
            <div className="col-lg-6" data-aos="zoom-in" data-aos-delay="100">
              <div className="mission-card">
                ...
                <p>
                  To build a modern learning platform that bridges the gap
                  between theoretical education and real IT industry
                  expectations using innovation, mentorship and AI-driven
                  learning.
                </p>
              </div>
            </div>
