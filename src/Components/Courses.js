          ...
          <div className="row justify-content-center text-center">
            <div className="col-lg-9">
              ...
              <p className="courses-description mt-4">
                Practical Business Analysis, Agile and AI-powered training
                programs designed for freshers, career switchers and working
                professionals.
              </p>
            </div>
          </div>
          ...
          <div className="row">
            ...
            >
              <div className="modern-course-card">
                <img
                  src={course1Image}
                  className="img-fluid modern-course-image"
                ...
                <div className="course-content">
                  ...
                  <p className="description">
                    Learn the real-world Business Analyst skills used inside IT
                    companies — including requirement gathering, stakeholder
                    communication, process modelling, Agile documentation,
                    Visio, Lucidchart and AI-powered workflows. Designed to help
                    freshers and professionals become job-ready Business
                    Analysts.
                  </p>
                  ...
                  <div className="course-footer mt-4">
                    ...
                    <Link to="/course-details-ba" className="modern-course-btn">
                      View Details →
                    </Link>
                  </div>
                </div>
            ...
            >
              <div className="modern-course-card">
                ...
                <div className="course-content">
                  ...
                  <p className="description">
                    Learn Agile and Scrum the way real software teams work in IT
                    companies. Gain practical experience with Scrum ceremonies,
